# TEST-546 — Startup/shutdown/recovery
...
Exercise release-level behavior in the Startup/shutdown/recovery surface.
...
User confirmed the required visual or physical observation in the normal production ARAMF executable.
...
User observation: required navigation/scroll/zoom/resize or monitor-placement behavior was usable with no blocking issue.
