# TEST-461 — Failure injection/filesystem/corrupt-data handling

## Category

Failure injection/filesystem/corrupt-data handling
...
Exercise release-level behavior in the Failure injection/filesystem/corrupt-data handling surface.
